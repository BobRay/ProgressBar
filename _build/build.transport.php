 ...
 */
/**
 * Build ProgressBar Package
 *
 * Description: Build script for ProgressBar package
 * @package progressbar
 * @subpackage build
 */

/* Set package info be sure to set all of these */
define('PKG_NAME','ProgressBar');
define('PKG_NAME_LOWER','progressbar');
define('PKG_VERSION','1.0.0');
define('PKG_RELEASE','beta1');
define('PKG_CATEGORY','ProgressBar');
...
/* This section transfers every file in the local
 progressbars/progressbar/assets directory to the
 target site's assets/progressbar directory on install.
...
/* This section transfers every file in the local 
 progressbars/progressbar/core directory to the
 target site's core/progressbar directory on install.
...
if ($hasSettings) {
    $settings = require $sources['data'].'transport.settings.php';
